...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/5.40.0/linux-android'),
    ...
    libpth => '/tmp/my-toolchain-aarch64-linux-android/sysroot/usr/lib /system/lib /vendor/lib /system/lib /vendor/lib /system/lib /vendor/lib /system/lib /vendor/lib',
    osname => 'android',
    osvers => '15',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/5.40.0'),
    scriptdir => '.../',
    sitearchexp => relocate_inc('.../../lib/site_perl/5.40.0/linux-android'),
    sitelibexp => relocate_inc('.../../lib/site_perl/5.40.0'),
    so => 'so',
    useithreads => undef,
