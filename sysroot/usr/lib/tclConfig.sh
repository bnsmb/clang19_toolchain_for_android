...
TCL_EXTRA_CFLAGS=' -I/system/usr/clang19/include -I/system/usr/ndk/r27d/include -I/system/usr/ndk/r27d/sysroot/usr/include --sysroot=/system/usr/ndk/r27d/sysroot -pipe -finput-charset=UTF-8  -I/system/usr/clang19/include -I/system/usr/ndk/r27d/include -I/system/usr/ndk/r27d/sysroot/usr/include --sysroot=/system/usr/ndk/r27d/sysroot'
...
TCL_LD_FLAGS=' -L/system/usr/ndk/r27d/sysroot/usr/lib/aarch64-linux-android/35 -L/system/usr/ndk/r27d/sysroot/usr/lib/aarch64-linux-android -B/system/usr/ndk/r27d/sysroot/usr/lib/aarch64-linux-android/35/ --sysroot=/system/usr/ndk/r27d/sysroot -lc   -Wl,--export-dynamic '
