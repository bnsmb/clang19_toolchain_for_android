...
cat='cat'
cc='cc'
cccdlflags='-fPIC --sysroot=/data/local/tmp/sysroot/'
ccdlflags='-Wl,-E'
...
config_arg2='-Dsysroot=/data/local/tmp/sysroot/'
...
lddlflags='-shared -O2 --sysroot=/data/local/tmp/sysroot/ -L/data/local/tmp/sysroot/usr/ndk/r27d/sysroot/usr/lib/aarch64-linux-android/31 -L/data/local/tmp/sysroot/usr/ndk/r27d/sysroot/usr/lib/aarch64-linux-android -L/data/local/tmp/develop/sysroot/usr/lib -fstack-protector-strong'
...
lns='/system/bin/ln -s'
localtime_r_proto='0'
locincpth=' /data/local/tmp/sysroot//usr/local/include /data/local/tmp/sysroot//opt/local/include /data/local/tmp/sysroot//usr/gnu/include /data/local/tmp/sysroot//opt/gnu/include /data/local/tmp/sysroot//usr/GNU/include /data/local/tmp/sysroot//opt/GNU/include'
loclibpth=' /data/local/tmp/sysroot//usr/local/lib /data/local/tmp/sysroot//opt/local/lib /data/local/tmp/sysroot//usr/gnu/lib /data/local/tmp/sysroot//opt/gnu/lib /data/local/tmp/sysroot//usr/GNU/lib /data/local/tmp/sysroot//opt/GNU/lib'
...
usevfork='false'
usrinc='/data/local/tmp/sysroot//usr/include'
uuname=''
uvXUformat='"lX"'
uvoformat='"lo"'
uvsize='8'
...
versiononly='undef'
vi=''
xlibpth=' /data/local/tmp/sysroot//usr/lib/386 /data/local/tmp/sysroot//lib/386'
