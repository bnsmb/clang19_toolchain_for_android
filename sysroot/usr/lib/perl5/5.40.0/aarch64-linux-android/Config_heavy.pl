...
ccdlflags='-Wl,-E'
ccflags='-fPIE -pie --std=gnu99 --sysroot=/data/local/tmp/sysroot -I/data/local/tmp/sysroot/usr/clang19/include -I/data/local/tmp/sysroot/usr/ndk/r27b/include -I/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/include -I/data/local/tmp/develop/sysroot/usr/include --sysroot=/data/local/tmp/sysroot/usr/ndk/r27b/sysroot -Wno-implicit-function-declaration -Wno-int-conversion -DHAS_SHMAT_PROTOTYPE -DNO_LOCALE -DNO_LOCALE -DNO_LOCALE_COLLATE -DNO_LOCALE_CTYPE -DNO_LOCALE_MESSAGES -DNO_LOCALE_MONETARY -DNO_LOCALE_NUMERIC -DNO_LOCALE_TIME -fno-strict-aliasing -pipe -fstack-protector-strong -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64'
...
config_arg3='-Dccflags= -fPIE -pie --std=gnu99 --sysroot=/data/local/tmp/sysroot  -I/data/local/tmp/sysroot/usr/clang19/include -I/data/local/tmp/sysroot/usr/ndk/r27b/include -I/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/include -I/data/local/tmp/develop/sysroot/usr/include --sysroot=/data/local/tmp/sysroot/usr/ndk/r27b/sysroot  -Wno-implicit-function-declaration -Wno-int-conversion -DHAS_SHMAT_PROTOTYPE -DNO_LOCALE '
config_arg4='-Uuselocale'
config_arg5='-Dldflags=-pie  -L/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android/31 -L/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android -L/data/local/tmp/develop/sysroot/usr/lib -B/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android/31/ --sysroot=/data/local/tmp/sysroot/usr/ndk/r27b/sysroot -lc   '
...
config_argc='8'
config_args='-Dprefix=/data/local/tmp/sysroot/usr -Dsysroot=/data/local/tnp/sysroot/ -Dccflags= -fPIE -pie --std=gnu99 --sysroot=/data/local/tmp/sysroot  -I/data/local/tmp/sysroot/usr/clang19/include -I/data/local/tmp/sysroot/usr/ndk/r27b/include -I/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/include -I/data/local/tmp/develop/sysroot/usr/include --sysroot=/data/local/tmp/sysroot/usr/ndk/r27b/sysroot  -Wno-implicit-function-declaration -Wno-int-conversion -DHAS_SHMAT_PROTOTYPE -DNO_LOCALE  -Uuselocale -Dldflags=-pie  -L/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android/31 -L/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android -L/data/local/tmp/develop/sysroot/usr/lib -B/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android/31/ --sysroot=/data/local/tmp/sysroot/usr/ndk/r27b/sysroot -lc    -Uusecrosscompile -Accflags=-DNO_LOCALE -DNO_LOCALE_COLLATE -DNO_LOCALE_CTYPE -DNO_LOCALE_MESSAGES -DNO_LOCALE_MONETARY -DNO_LOCALE_NUMERIC -DNO_LOCALE_TIME -Dnoextensions=Locale'
contains='grep'
cp='cp'
cpio=''
cpp='cpp'
...
gidsize='4'
gidtype='gid_t'
glibpth=' /data/local/tnp/sysroot//usr/shlib /data/local/tnp/sysroot//lib /data/local/tnp/sysroot//usr/lib /data/local/tnp/sysroot//usr/lib/386 /data/local/tnp/sysroot//lib/386 /data/local/tnp/sysroot//usr/ccs/lib /data/local/tnp/sysroot//usr/ucblib /data/local/tnp/sysroot//usr/local/lib'
gmake='gmake'
gmtime_r_proto='0'
gnulibc_version=''
grep='grep'
...
incpath=''
incpth='/data/local/tmp/sysroot/usr/clang19/include /data/local/tmp/sysroot/usr/ndk/r27b/include /data/local/tmp/develop/sysroot/usr/include /data/local/tmp/sysroot/usr/clang19/lib/clang/19/include /data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/include/aarch64-linux-android /data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/include'
inews=''
...
lddlflags='-shared -O2 --sysroot=/data/local/tnp/sysroot/ -L/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android/31 -L/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android -L/data/local/tmp/develop/sysroot/usr/lib -fstack-protector-strong'
ldflags='-pie -L/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android/31 -L/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android -L/data/local/tmp/develop/sysroot/usr/lib -B/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android/31/ --sysroot=/data/local/tmp/sysroot/usr/ndk/r27b/sysroot -lc  -fstack-protector-strong'
ldflags_uselargefiles=''
ldlibpthname='LD_LIBRARY_PATH'
less='less'
lib_ext='.a'
libc='/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android/libc.a'
libperl='libperl.a'
...
libsdirs=' /data/local/tmp/develop/sysroot/usr/lib /data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android'
libsfiles=' libpthread.so libgdbm.so libdl.a libm.a libcrypt.so libc.a libgdbm_compat.so'
libsfound=' /data/local/tmp/develop/sysroot/usr/lib/libpthread.so /data/local/tmp/develop/sysroot/usr/lib/libgdbm.so /data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android/libdl.a /data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android/libm.a /data/local/tmp/develop/sysroot/usr/lib/libcrypt.so /data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android/libc.a /data/local/tmp/develop/sysroot/usr/lib/libgdbm_compat.so'
libspath=' /data/local/tmp/sysroot/usr/clang19/lib /data/local/tmp/sysroot/usr/ndk/r27b/lib /data/local/tmp/develop/sysroot/usr/lib /data/local/tmp/sysroot/usr/clang19/lib/clang/19/lib /data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android /data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib /data/local/tmp/sysroot/usr/clang19/lib/clang/19 /data/local/tmp/sysroot/usr/ndk/r27b/lib/clang/19/lib/aarch64-unknown-linux-android'
...
phostname='hostname'
pidtype='pid_t'
plibpth='/data/local/tmp/sysroot/usr/clang19/lib/clang/19 /data/local/tmp/sysroot/usr/clang19/lib/clang/19/lib/aarch64-unknown-linux-android /data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android /data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib'
pmake=''
pr=''
prefix='.../..'
prefixexp='.../..'
...
tee=''
test='test'
timeincl='/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/include/sys/time.h '
timetype='time_t'
tmpnam_r_proto='0'
to=':'
touch='touch'
...
ldflags_nolargefiles='-pie -L/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android/31 -L/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android -L/data/local/tmp/develop/sysroot/usr/lib -B/data/local/tmp/sysroot/usr/ndk/r27b/sysroot/usr/lib/aarch64-linux-android/31/ --sysroot=/data/local/tmp/sysroot/usr/ndk/r27b/sysroot -lc  -fstack-protector-strong'
