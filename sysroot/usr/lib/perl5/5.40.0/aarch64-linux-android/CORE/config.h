 ...
 */
#define ARCHLIB ".../../lib/perl5/5.40.0/aarch64-linux-android"		/**/
#define ARCHLIB_EXP ".../../lib/perl5/5.40.0/aarch64-linux-android"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PRIVLIB ".../../lib/perl5/5.40.0"		/**/
#define PRIVLIB_EXP ".../../lib/perl5/5.40.0"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH ".../../lib/perl5/site_perl/5.40.0/aarch64-linux-android"		/**/
#define SITEARCH_EXP ".../../lib/perl5/site_perl/5.40.0/aarch64-linux-android"		/**/
 ...
 */
#define SITELIB "/data/local/tmp/sysroot/usr/lib/perl5/site_perl/5.40.0"		/**/
#define SITELIB_EXP "/data/local/tmp/sysroot/usr/lib/perl5/site_perl/5.40.0"		/**/
#define SITELIB_STEM "/data/local/tmp/sysroot/usr/lib/perl5/site_perl"		/**/
...
#ifdef HAS_PHOSTNAME
#define PHOSTNAME "/data/local/tmp/develop/sysroot/usr/bin/hostname"	/* How to get the host name */
#endif
 ...
 *	some shell.
 */
#define STARTPERL "#!/data/local/tmp/sysroot/usr/bin/perl"		/**/
