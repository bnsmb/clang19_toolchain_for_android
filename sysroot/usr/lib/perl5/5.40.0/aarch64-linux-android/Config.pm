...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/perl5/5.40.0/aarch64-linux-android'),
    ...
    osvers => '15',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/perl5/5.40.0'),
    scriptdir => '/data/local/tmp/sysroot/usr/bin',
    sitearchexp => relocate_inc('.../../lib/perl5/site_perl/5.40.0/aarch64-linux-android'),
