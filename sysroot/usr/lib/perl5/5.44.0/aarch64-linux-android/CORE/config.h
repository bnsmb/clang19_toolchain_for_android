...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Sat Jul 25 18:37:21 CEST 2026
 * Configured by     : shell
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/data/local/tmp/sysroot/usr/lib/perl5/site_perl/5.44.0/aarch64-linux-android"		/**/
#define SITEARCH_EXP "/data/local/tmp/sysroot/usr/lib/perl5/site_perl/5.44.0/aarch64-linux-android"		/**/
 ...
 */
#define SITELIB "/data/local/tmp/sysroot/usr/lib/perl5/site_perl/5.44.0"		/**/
#define SITELIB_EXP "/data/local/tmp/sysroot/usr/lib/perl5/site_perl/5.44.0"		/**/
