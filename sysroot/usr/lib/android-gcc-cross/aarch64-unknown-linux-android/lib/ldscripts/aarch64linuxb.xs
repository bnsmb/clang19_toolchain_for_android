...
OUTPUT_ARCH(aarch64)
ENTRY(_start)
SEARCH_DIR("=/tmp/android-gcc-cross/aarch64-unknown-linux-android/lib64"); SEARCH_DIR("=/tmp/android-gcc-cross/lib64"); SEARCH_DIR("=/usr/local/lib64"); SEARCH_DIR("=/lib64"); SEARCH_DIR("=/usr/lib64"); SEARCH_DIR("=/tmp/android-gcc-cross/aarch64-unknown-linux-android/lib"); SEARCH_DIR("=/tmp/android-gcc-cross/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
