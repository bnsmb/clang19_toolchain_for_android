...
ENTRY(_start)
SEARCH_DIR("=/tmp/android-gcc-cross/aarch64-unknown-linux-android/libilp32"); SEARCH_DIR("=/tmp/android-gcc-cross/libilp32"); SEARCH_DIR("=/usr/local/libilp32"); SEARCH_DIR("=/libilp32"); SEARCH_DIR("=/usr/libilp32"); SEARCH_DIR("=/tmp/android-gcc-cross/aarch64-unknown-linux-android/lib"); SEARCH_DIR("=/tmp/android-gcc-cross/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
