...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/tmp/android-gcc-cross/aarch64-unknown-linux-android/lib"); SEARCH_DIR("=/tmp/android-gcc-cross/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
