...
extern bool const0_to_1_operand (rtx, machine_mode);
...
extern bool aarch64_comparison_operator_cc (rtx, machine_mode);
extern bool aarch64_equality_operator (rtx, machine_mode);
extern bool aarch64_cbranch_compare_operation (rtx, machine_mode);
...
extern bool aarch64_granule16_memory_operand (rtx, machine_mode);
extern bool aarch64_granule16_imm6 (rtx, machine_mode);
