 ...
 */
AMediaCodec* AMediaCodec_createCodecByName(const char *name) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
AMediaCodec* AMediaCodec_createDecoderByType(const char *mime_type) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
AMediaCodec* AMediaCodec_createEncoderByType(const char *mime_type) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
media_status_t AMediaCodec_delete(AMediaCodec*) __INTRODUCED_IN_API_L__;
...
media_status_t AMediaCodec_configure(
        ...
        AMediaCrypto *crypto,
        uint32_t flags) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
media_status_t AMediaCodec_start(AMediaCodec*) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
media_status_t AMediaCodec_stop(AMediaCodec*) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
media_status_t AMediaCodec_flush(AMediaCodec*) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
uint8_t* AMediaCodec_getInputBuffer(AMediaCodec*, size_t idx, size_t *out_size) __INTRODUCED_IN_API_L__;
 ...
 */
uint8_t* AMediaCodec_getOutputBuffer(AMediaCodec*, size_t idx, size_t *out_size) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
ssize_t AMediaCodec_dequeueInputBuffer(AMediaCodec*, int64_t timeoutUs) __INTRODUCED_IN_API_L__;
...
media_status_t AMediaCodec_queueInputBuffer(AMediaCodec*, size_t idx,
                                            ...
                                            uint64_t time, uint32_t flags) __INTRODUCED_IN_API_L__;
...
ssize_t AMediaCodec_dequeueOutputBuffer(AMediaCodec*, AMediaCodecBufferInfo *info,
        int64_t timeoutUs) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
AMediaFormat* AMediaCodec_getOutputFormat(AMediaCodec*) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
media_status_t AMediaCodec_releaseOutputBuffer(AMediaCodec*, size_t idx, bool render) __INTRODUCED_IN_API_L__;
 ...
 */
media_status_t AMediaCodec_setOutputSurface(AMediaCodec*, ANativeWindow* surface) __INTRODUCED_IN_API_N__;
...
media_status_t AMediaCodec_releaseOutputBufferAtTime(
        AMediaCodec *mData, size_t idx, int64_t timestampNs) __INTRODUCED_IN_API_L__;
...
media_status_t AMediaCodec_createInputSurface(
        AMediaCodec *mData, ANativeWindow **surface) __INTRODUCED_IN_API_O__;
...
media_status_t AMediaCodec_createPersistentInputSurface(
        ANativeWindow **surface) __INTRODUCED_IN_API_O__;
...
media_status_t AMediaCodec_setParameters(
        AMediaCodec *mData, const AMediaFormat* params) __INTRODUCED_IN_API_O__;
 ...
 * Available since API level 26.
 */
media_status_t AMediaCodec_signalEndOfInputStream(AMediaCodec *mData) __INTRODUCED_IN_API_O__;
 ...
 */
AMediaFormat* AMediaCodec_getBufferFormat(AMediaCodec*, size_t index) __INTRODUCED_IN_API_P__;
 ...
 * Available since API level 28.
 */
media_status_t AMediaCodec_getName(AMediaCodec*, char** out_name) __INTRODUCED_IN_API_P__;
 ...
 * Available since API level 28.
 */
void AMediaCodec_releaseName(AMediaCodec*, char* name) __INTRODUCED_IN_API_P__;
...
media_status_t AMediaCodec_setAsyncNotifyCallback(
        ...
        void *userdata) __INTRODUCED_IN_API_P__;
...
media_status_t AMediaCodec_setOnFrameRenderedCallback(
        ...
        void *userdata) __INTRODUCED_IN_API_T__;
 ...
 * Available since API level 28.
 */
media_status_t AMediaCodec_releaseCrypto(AMediaCodec*) __INTRODUCED_IN_API_P__;
 ...
 * Available since API level 28.
 */
AMediaFormat* AMediaCodec_getInputFormat(AMediaCodec*) __INTRODUCED_IN_API_P__;
 ...
 * Available since API level 28.
 */
bool AMediaCodecActionCode_isRecoverable(int32_t actionCode) __INTRODUCED_IN_API_P__;
 ...
 * Available since API level 28.
 */
bool AMediaCodecActionCode_isTransient(int32_t actionCode) __INTRODUCED_IN_API_P__;
...
AMediaCodecCryptoInfo *AMediaCodecCryptoInfo_new(
        ...
        size_t *clearbytes,
        size_t *encryptedbytes) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
media_status_t AMediaCodecCryptoInfo_delete(AMediaCodecCryptoInfo*) __INTRODUCED_IN_API_L__;
...
void AMediaCodecCryptoInfo_setPattern(
        ...
        cryptoinfo_pattern_t *pattern) __INTRODUCED_IN_API_N__;
 ...
 * Available since API level 21.
 */
size_t AMediaCodecCryptoInfo_getNumSubSamples(AMediaCodecCryptoInfo*) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
media_status_t AMediaCodecCryptoInfo_getKey(AMediaCodecCryptoInfo*, uint8_t *dst) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
media_status_t AMediaCodecCryptoInfo_getIV(AMediaCodecCryptoInfo*, uint8_t *dst) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
cryptoinfo_mode_t AMediaCodecCryptoInfo_getMode(AMediaCodecCryptoInfo*) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
media_status_t AMediaCodecCryptoInfo_getClearBytes(AMediaCodecCryptoInfo*, size_t *dst) __INTRODUCED_IN_API_L__;
 ...
 * Available since API level 21.
 */
media_status_t AMediaCodecCryptoInfo_getEncryptedBytes(AMediaCodecCryptoInfo*, size_t *dst) __INTRODUCED_IN_API_L__;

extern const char* AMEDIACODEC_KEY_HDR10_PLUS_INFO __INTRODUCED_IN_API_S__;
extern const char* AMEDIACODEC_KEY_LOW_LATENCY __INTRODUCED_IN_API_S__;
extern const char* AMEDIACODEC_KEY_OFFSET_TIME __INTRODUCED_IN_API_S__;
extern const char* AMEDIACODEC_KEY_REQUEST_SYNC_FRAME __INTRODUCED_IN_API_S__;
extern const char* AMEDIACODEC_KEY_SUSPEND __INTRODUCED_IN_API_S__;
extern const char* AMEDIACODEC_KEY_SUSPEND_TIME __INTRODUCED_IN_API_S__;
extern const char* AMEDIACODEC_KEY_VIDEO_BITRATE __INTRODUCED_IN_API_S__;
