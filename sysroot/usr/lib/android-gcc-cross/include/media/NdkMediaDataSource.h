 ...
 */
AMediaDataSource* AMediaDataSource_new() __INTRODUCED_IN_API_P__;
...
AMediaDataSource* AMediaDataSource_newUri(const char *uri,
        int numheaders,
        const char * const *key_values) __INTRODUCED_IN_API_Q__;
 ...
 * Available since API level 28.
 */
void AMediaDataSource_delete(AMediaDataSource*) __INTRODUCED_IN_API_P__;
...
void AMediaDataSource_setUserdata(
        AMediaDataSource*, void *userdata) __INTRODUCED_IN_API_P__;
...
void AMediaDataSource_setReadAt(
        AMediaDataSource*,
        AMediaDataSourceReadAt) __INTRODUCED_IN_API_P__;
...
void AMediaDataSource_setGetSize(
        AMediaDataSource*,
        AMediaDataSourceGetSize) __INTRODUCED_IN_API_P__;
...
void AMediaDataSource_setClose(
        AMediaDataSource*,
        AMediaDataSourceClose) __INTRODUCED_IN_API_P__;
 ...
 * Available since API level 29.
 */
void AMediaDataSource_close(AMediaDataSource*) __INTRODUCED_IN_API_Q__;
...
void AMediaDataSource_setGetAvailableSize(
        AMediaDataSource*,
        AMediaDataSourceGetAvailableSize) __INTRODUCED_IN_API_Q__;
