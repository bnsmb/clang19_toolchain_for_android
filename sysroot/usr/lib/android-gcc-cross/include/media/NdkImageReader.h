...
media_status_t AImageReader_new(
        ...
        /*out*/AImageReader** reader) __INTRODUCED_IN_API_N__;
 ...
 */
void AImageReader_delete(AImageReader* reader) __INTRODUCED_IN_API_N__;
 ...
 */
media_status_t AImageReader_getWindow(AImageReader* reader, /*out*/ANativeWindow** window) __INTRODUCED_IN_API_N__;
 ...
 */
media_status_t AImageReader_getWidth(const AImageReader* reader, /*out*/int32_t* width) __INTRODUCED_IN_API_N__;
 ...
 */
media_status_t AImageReader_getHeight(const AImageReader* reader, /*out*/int32_t* height) __INTRODUCED_IN_API_N__;
 ...
 */
media_status_t AImageReader_getFormat(const AImageReader* reader, /*out*/int32_t* format) __INTRODUCED_IN_API_N__;
 ...
 */
media_status_t AImageReader_getMaxImages(const AImageReader* reader, /*out*/int32_t* maxImages) __INTRODUCED_IN_API_N__;
 ...
 */
media_status_t AImageReader_acquireNextImage(AImageReader* reader, /*out*/AImage** image) __INTRODUCED_IN_API_N__;
 ...
 */
media_status_t AImageReader_acquireLatestImage(AImageReader* reader, /*out*/AImage** image) __INTRODUCED_IN_API_N__;
...
media_status_t AImageReader_setImageListener(
        AImageReader* reader, AImageReader_ImageListener* listener) __INTRODUCED_IN_API_N__;
...
media_status_t AImageReader_newWithUsage(
        ...
        /*out*/ AImageReader** reader) __INTRODUCED_IN_API_O__;
...
media_status_t AImageReader_newWithDataSpace(int32_t width, int32_t height, uint64_t usage,
        ...
        /*out*/ AImageReader** reader) __INTRODUCED_IN_API_U__;
...
media_status_t AImageReader_acquireNextImageAsync(
        AImageReader* reader, /*out*/AImage** image, /*out*/int* acquireFenceFd) __INTRODUCED_IN_API_O__;
...
media_status_t AImageReader_setBufferRemovedListener(
        AImageReader* reader, AImageReader_BufferRemovedListener* listener) __INTRODUCED_IN_API_O__;
