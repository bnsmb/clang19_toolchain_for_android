 ...
 */
camera_status_t ACameraDevice_close(ACameraDevice* device) __INTRODUCED_IN_API_N__;
 ...
 * has been closed.
 */
const char* ACameraDevice_getId(const ACameraDevice* device) __INTRODUCED_IN_API_N__;
...
camera_status_t ACameraDevice_createCaptureRequest(
        ...
        /*out*/ACaptureRequest** request) __INTRODUCED_IN_API_N__;
...
camera_status_t ACaptureSessionOutputContainer_create(
        /*out*/ACaptureSessionOutputContainer** container) __INTRODUCED_IN_API_N__;
...
camera_status_t ACaptureSessionOutput_create(
        ANativeWindow* anw, /*out*/ACaptureSessionOutput** output) __INTRODUCED_IN_API_N__;
 ...
 */
void            ACaptureSessionOutput_free(ACaptureSessionOutput* output) __INTRODUCED_IN_API_N__;
...
camera_status_t ACameraDevice_createCaptureSession(
        ...
        /*out*/ACameraCaptureSession** session) __INTRODUCED_IN_API_N__;
...
camera_status_t ACaptureSessionSharedOutput_create(
        ANativeWindow* anw, /*out*/ACaptureSessionOutput** output) __INTRODUCED_IN_API_P__;
...
camera_status_t ACaptureSessionSharedOutput_add(ACaptureSessionOutput *output,
        ANativeWindow *anw) __INTRODUCED_IN_API_P__;
...
camera_status_t ACameraDevice_createCaptureSessionWithSessionParameters(
        ...
        const ACameraCaptureSession_stateCallbacks* callbacks,
        /*out*/ACameraCaptureSession** session) __INTRODUCED_IN_API_P__;
...
camera_status_t ACaptureSessionPhysicalOutput_create(
        ...
        /*out*/ACaptureSessionOutput** output) __INTRODUCED_IN_API_Q__;
...
camera_status_t ACameraDevice_createCaptureRequest_withPhysicalIds(
        ...
        /*out*/ACaptureRequest** request) __INTRODUCED_IN_API_Q__;
...
camera_status_t ACameraDevice_isSessionConfigurationSupported(
        ...
        const ACaptureSessionOutputContainer* sessionOutputContainer) __INTRODUCED_IN_API_Q__;
