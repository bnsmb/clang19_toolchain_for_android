...
camera_status_t ACameraCaptureSession_getDevice(
        ACameraCaptureSession* session, /*out*/ACameraDevice** device) __INTRODUCED_IN_API_N__;
...
camera_status_t ACameraCaptureSession_capture(
        ...
        /*optional*/int* captureSequenceId) __INTRODUCED_IN_API_N__;
...
camera_status_t ACameraCaptureSession_updateSharedOutput(ACameraCaptureSession* session,
        ACaptureSessionOutput* output) __INTRODUCED_IN_API_P__;
...
camera_status_t ACameraCaptureSession_logicalCamera_capture(
        ...
        int numRequests, ACaptureRequest** requests,
        /*optional*/int* captureSequenceId) __INTRODUCED_IN_API_Q__;
...
camera_status_t ACameraCaptureSession_captureV2(
        ...
        int numRequests, ACaptureRequest** requests,
        /*optional*/int* captureSequenceId) __INTRODUCED_IN_API_T__;
...
camera_status_t ACameraCaptureSession_setWindowPreparedCallback(
    ACameraCaptureSession* session,
    void *context,
    ACameraCaptureSession_prepareCallback callback) __INTRODUCED_IN_API_U__;
...
camera_status_t ACameraCaptureSession_prepareWindow(
    ACameraCaptureSession* session,
    ANativeWindow *window) __INTRODUCED_IN_API_U__;
...
camera_status_t ACameraCaptureSessionShared_startStreaming(
    ...
    /*optional*/int *captureSequenceId) __INTRODUCED_IN_API_W__;
...
camera_status_t ACameraCaptureSessionShared_stopStreaming(
    ACameraCaptureSession* sharedSession)  __INTRODUCED_IN_API_W__;
__END_DECLS
