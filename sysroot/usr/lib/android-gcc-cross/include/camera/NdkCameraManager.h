 ...
 *
 */
ACameraManager* ACameraManager_create() __INTRODUCED_IN_API_N__;
 ...
 */
void ACameraManager_delete(ACameraManager* manager) __INTRODUCED_IN_API_N__;
...
camera_status_t ACameraManager_getCameraIdList(ACameraManager* manager,
        /*out*/ACameraIdList** cameraIdList) __INTRODUCED_IN_API_N__;
 ...
 */
void ACameraManager_deleteCameraIdList(ACameraIdList* cameraIdList) __INTRODUCED_IN_API_N__;
...
camera_status_t ACameraManager_registerAvailabilityCallback(
        ...
        const ACameraManager_AvailabilityCallbacks* callback) __INTRODUCED_IN_API_N__;
...
camera_status_t ACameraManager_getCameraCharacteristics(
        ...
        /*out*/ACameraMetadata** characteristics) __INTRODUCED_IN_API_N__;
...
camera_status_t ACameraManager_openCamera(
        ...
        /*out*/ACameraDevice** device) __INTRODUCED_IN_API_N__;
...
camera_status_t ACameraManager_openSharedCamera(
        ACameraManager* manager, const char* cameraId,
        ACameraDevice_StateCallbacks* callback,
        /*out*/ACameraDevice** device,/*out*/bool* isPrimaryClient) __INTRODUCED_IN_API_W__;
...
typedef struct ACameraManager_ExtendedAvailabilityListener {
    ...
    ACameraManager_PhysicalCameraAvailabilityCallback onPhysicalCameraAvailable __INTRODUCED_IN_API_R__;
...
camera_status_t ACameraManager_registerExtendedAvailabilityCallback(
        ACameraManager* manager,
        const ACameraManager_ExtendedAvailabilityCallbacks* callback) __INTRODUCED_IN_API_Q__;
...
camera_status_t ACameraManager_isCameraDeviceSharingSupported(
        ACameraManager *manager,
        const char *cameraId,
        bool *isSharingSupported) __INTRODUCED_IN_API_W__;
