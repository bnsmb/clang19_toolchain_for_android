...
camera_status_t ACameraMetadata_getConstEntry(
        ...
        uint32_t tag, /*out*/ACameraMetadata_const_entry* entry) __INTRODUCED_IN_API_N__;
...
camera_status_t ACameraMetadata_getAllTags(
        const ACameraMetadata* metadata,
        /*out*/int32_t* numEntries, /*out*/const uint32_t** tags) __INTRODUCED_IN_API_N__;
...
camera_status_t
ACameraMetadata_getTagFromName(const ACameraMetadata* metadata, const char *name, uint32_t *tag)  __INTRODUCED_IN_API_V__;
 ...
 */
ACameraMetadata* ACameraMetadata_copy(const ACameraMetadata* src) __INTRODUCED_IN_API_N__;
 ...
 */
void ACameraMetadata_free(ACameraMetadata* metadata) __INTRODUCED_IN_API_N__;
