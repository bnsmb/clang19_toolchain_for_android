...
camera_status_t ACameraOutputTarget_create(ANativeWindow* window,
        ACameraOutputTarget** output) __INTRODUCED_IN_API_N__;
 ...
 */
void ACameraOutputTarget_free(ACameraOutputTarget* output) __INTRODUCED_IN_API_N__;
...
camera_status_t ACaptureRequest_addTarget(ACaptureRequest* request,
        const ACameraOutputTarget* output) __INTRODUCED_IN_API_N__;
...
camera_status_t ACaptureRequest_getConstEntry(
        const ACaptureRequest* request, uint32_t tag, ACameraMetadata_const_entry* entry) __INTRODUCED_IN_API_N__;
...
camera_status_t ACaptureRequest_getAllTags(
        const ACaptureRequest* request, /*out*/int32_t* numTags, /*out*/const uint32_t** tags) __INTRODUCED_IN_API_N__;
...
camera_status_t ACaptureRequest_setEntry_u8(
        ACaptureRequest* request, uint32_t tag, uint32_t count, const uint8_t* data) __INTRODUCED_IN_API_N__;
...
camera_status_t ACaptureRequest_setEntry_i32(
        ACaptureRequest* request, uint32_t tag, uint32_t count, const int32_t* data) __INTRODUCED_IN_API_N__;
...
camera_status_t ACaptureRequest_setEntry_float(
        ACaptureRequest* request, uint32_t tag, uint32_t count, const float* data) __INTRODUCED_IN_API_N__;
...
camera_status_t ACaptureRequest_setEntry_i64(
        ACaptureRequest* request, uint32_t tag, uint32_t count, const int64_t* data) __INTRODUCED_IN_API_N__;
...
camera_status_t ACaptureRequest_setEntry_double(
        ACaptureRequest* request, uint32_t tag, uint32_t count, const double* data) __INTRODUCED_IN_API_N__;
...
camera_status_t ACaptureRequest_setEntry_rational(
        ...
        const ACameraMetadata_rational* data) __INTRODUCED_IN_API_N__;
 ...
 */
void ACaptureRequest_free(ACaptureRequest* request) __INTRODUCED_IN_API_N__;
...
camera_status_t ACaptureRequest_setUserContext(
        ACaptureRequest* request, void* context) __INTRODUCED_IN_API_P__;
...
camera_status_t ACaptureRequest_getUserContext(
        const ACaptureRequest* request, /*out*/void** context) __INTRODUCED_IN_API_P__;
 ...
 */
ACaptureRequest* ACaptureRequest_copy(const ACaptureRequest* src) __INTRODUCED_IN_API_P__;
...
camera_status_t ACaptureRequest_getConstEntry_physicalCamera(
        ...
        ACameraMetadata_const_entry* entry) __INTRODUCED_IN_API_Q__;
...
camera_status_t ACaptureRequest_setEntry_physicalCamera_u8(
        ...
        uint32_t count, const uint8_t* data) __INTRODUCED_IN_API_Q__;
...
camera_status_t ACaptureRequest_setEntry_physicalCamera_i32(
        ACaptureRequest* request, const char* physicalId, uint32_t tag,
        uint32_t count, const int32_t* data) __INTRODUCED_IN_API_Q__;
...
camera_status_t ACaptureRequest_setEntry_physicalCamera_float(
        ACaptureRequest* request, const char* physicalId, uint32_t tag,
        uint32_t count, const float* data) __INTRODUCED_IN_API_Q__;
...
camera_status_t ACaptureRequest_setEntry_physicalCamera_i64(
        ACaptureRequest* request, const char* physicalId, uint32_t tag,
        uint32_t count, const int64_t* data) __INTRODUCED_IN_API_Q__;
...
camera_status_t ACaptureRequest_setEntry_physicalCamera_double(
        ACaptureRequest* request, const char* physicalId, uint32_t tag,
        uint32_t count, const double* data) __INTRODUCED_IN_API_Q__;
...
camera_status_t ACaptureRequest_setEntry_physicalCamera_rational(
        ACaptureRequest* request, const char* physicalId, uint32_t tag,
        uint32_t count, const ACameraMetadata_rational* data) __INTRODUCED_IN_API_Q__;
