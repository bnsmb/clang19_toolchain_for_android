 ...
 */
void AIBinder_Class_setOnDump(AIBinder_Class* clazz, AIBinder_onDump onDump) __INTRODUCED_IN_API_Q__;
 ...
 */
void AIBinder_Class_disableInterfaceTokenHeader(AIBinder_Class* clazz) __INTRODUCED_IN_API_T__;
 ...
 */
bool AIBinder_isRemote(const AIBinder* binder) __INTRODUCED_IN_API_Q__;
 ...
 */
bool AIBinder_isAlive(const AIBinder* binder) __INTRODUCED_IN_API_Q__;
 ...
 */
binder_status_t AIBinder_ping(AIBinder* binder) __INTRODUCED_IN_API_Q__;
...
binder_status_t AIBinder_linkToDeath(AIBinder* binder, AIBinder_DeathRecipient* recipient,
                                     void* cookie) __INTRODUCED_IN_API_Q__;
 ...
 */
uid_t AIBinder_getCallingUid() __INTRODUCED_IN_API_Q__;
 ...
 */
pid_t AIBinder_getCallingPid() __INTRODUCED_IN_API_Q__;
 ...
 * otherwise.
 */
bool AIBinder_isHandlingTransaction() __INTRODUCED_IN_API_T__;
 ...
 */
void AIBinder_incStrong(AIBinder* binder) __INTRODUCED_IN_API_Q__;
 ...
 */
void AIBinder_decStrong(AIBinder* binder) __INTRODUCED_IN_API_Q__;
 ...
 * -1.
 */
int32_t AIBinder_debugGetRefCount(AIBinder* binder) __INTRODUCED_IN_API_Q__;
 ...
 */
bool AIBinder_associateClass(AIBinder* binder, const AIBinder_Class* clazz) __INTRODUCED_IN_API_Q__;
 ...
 */
const AIBinder_Class* AIBinder_getClass(AIBinder* binder) __INTRODUCED_IN_API_Q__;
 ...
 */
void* AIBinder_getUserData(AIBinder* binder) __INTRODUCED_IN_API_Q__;
 ...
 */
binder_status_t AIBinder_prepareTransaction(AIBinder* binder, AParcel** in) __INTRODUCED_IN_API_Q__;
...
binder_status_t AIBinder_transact(AIBinder* binder, transaction_code_t code, AParcel** in,
                                  AParcel** out, binder_flags_t flags) __INTRODUCED_IN_API_Q__;
 ...
 */
void AIBinder_Weak_delete(AIBinder_Weak* weakBinder) __INTRODUCED_IN_API_Q__;
 ...
 */
typedef void (*AIBinder_DeathRecipient_onBinderDied)(void* cookie) __INTRODUCED_IN_API_Q__;
 ...
 * \param cookie the cookie passed to AIBinder_linkToDeath.
 */
typedef void (*AIBinder_DeathRecipient_onBinderUnlinked)(void* cookie) __INTRODUCED_IN_API_T__;
...
__attribute__((warn_unused_result)) AIBinder_DeathRecipient* AIBinder_DeathRecipient_new(
        AIBinder_DeathRecipient_onBinderDied onBinderDied) __INTRODUCED_IN_API_Q__;
 ...
 */
void AIBinder_DeathRecipient_delete(AIBinder_DeathRecipient* recipient) __INTRODUCED_IN_API_Q__;
 ...
 */
binder_status_t AIBinder_getExtension(AIBinder* binder, AIBinder** outExt) __INTRODUCED_IN_API_R__;
 ...
 */
binder_status_t AIBinder_setExtension(AIBinder* binder, AIBinder* ext) __INTRODUCED_IN_API_R__;
 ...
 */
const char* AIBinder_Class_getDescriptor(const AIBinder_Class* clazz) __INTRODUCED_IN_API_S__;
 ...
 */
bool AIBinder_lt(const AIBinder* lhs, const AIBinder* rhs) __INTRODUCED_IN_API_S__;
 ...
 */
AIBinder_Weak* AIBinder_Weak_clone(const AIBinder_Weak* weak) __INTRODUCED_IN_API_S__;
 ...
 * \return whether "lhs < rhs" is true
 */
bool AIBinder_Weak_lt(const AIBinder_Weak* lhs, const AIBinder_Weak* rhs) __INTRODUCED_IN_API_S__;
