 ...
 */
void AInputEvent_release(const AInputEvent* event) __INTRODUCED_IN_API_S__;
 ...
 * Available since API level 31.
 */
const AInputEvent* AKeyEvent_fromJava(JNIEnv* env, jobject keyEvent) __INTRODUCED_IN_API_S__;
 ...
 * Available since API level 31.
 */
const AInputEvent* AMotionEvent_fromJava(JNIEnv* env, jobject motionEvent) __INTRODUCED_IN_API_S__;
 ...
 */
jobject AInputEvent_toJava(JNIEnv* env, const AInputEvent* aInputEvent) __INTRODUCED_IN_API_V__;
 ...
 */
AInputQueue* AInputQueue_fromJava(JNIEnv* env, jobject inputQueue) __INTRODUCED_IN_API_T__;
