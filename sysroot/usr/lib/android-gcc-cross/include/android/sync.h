 ...
 */
int32_t sync_merge(const char* name, int32_t fd1, int32_t fd2) __INTRODUCED_IN_API_O__;
 ...
 * Available since API level 26.
 */
struct sync_file_info* sync_file_info(int32_t fd) __INTRODUCED_IN_API_O__;
 ...
 * Available since API level 26.
 */
void sync_file_info_free(struct sync_file_info* info) __INTRODUCED_IN_API_O__;
