 ...
 */
int32_t AConfiguration_getScreenRound(AConfiguration* config) __INTRODUCED_IN_API_R__;
 ...
 */
int32_t AConfiguration_getLayoutDirection(AConfiguration* config) __INTRODUCED_IN_API_J_MR1__;
 ...
 * Available since API level 17.
 */
void AConfiguration_setLayoutDirection(AConfiguration* config, int32_t value) __INTRODUCED_IN_API_J_MR1__;
