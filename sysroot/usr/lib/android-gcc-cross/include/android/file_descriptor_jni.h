 ...
 */
jobject AFileDescriptor_create(JNIEnv* env) __INTRODUCED_IN_API_S__;
 ...
 */
int AFileDescriptor_getFd(JNIEnv* env, jobject fileDescriptor) __INTRODUCED_IN_API_S__;
 ...
 */
void AFileDescriptor_setFd(JNIEnv* env, jobject fileDescriptor, int fd) __INTRODUCED_IN_API_S__;
