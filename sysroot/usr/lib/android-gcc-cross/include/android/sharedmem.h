 ...
 */
int ASharedMemory_create(const char *name, size_t size) __INTRODUCED_IN_API_O__;
 ...
 */
size_t ASharedMemory_getSize(int fd) __INTRODUCED_IN_API_O__;
 ...
 */
int ASharedMemory_setProt(int fd, int prot) __INTRODUCED_IN_API_O__;
