 ...
 */
AChoreographer* AChoreographer_getInstance() __INTRODUCED_IN_API_N__;
...
void AChoreographer_postFrameCallback(AChoreographer* choreographer,
        ...
        __INTRODUCED_IN_API_N__ __DEPRECATED_IN(29, "Use AChoreographer_postFrameCallback64 instead");
...
void AChoreographer_postFrameCallbackDelayed(AChoreographer* choreographer,
                                             AChoreographer_frameCallback callback, void* data,
                                             long delayMillis) __INTRODUCED_IN_API_N__
...
void AChoreographer_postFrameCallbackDelayed64(AChoreographer* choreographer,
                                               AChoreographer_frameCallback64 callback, void* data,
                                               uint32_t delayMillis) __INTRODUCED_IN_API_Q__;
...
int64_t AChoreographerFrameCallbackData_getFrameTimeNanos(
        const AChoreographerFrameCallbackData* data) __INTRODUCED_IN_API_T__;
...
AVsyncId AChoreographerFrameCallbackData_getFrameTimelineVsyncId(
        const AChoreographerFrameCallbackData* data, size_t index) __INTRODUCED_IN_API_T__;
