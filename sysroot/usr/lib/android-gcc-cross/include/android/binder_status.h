 ...
 */
__attribute__((warn_unused_result)) AStatus* AStatus_newOk() __INTRODUCED_IN_API_Q__;
...
__attribute__((warn_unused_result)) AStatus* AStatus_fromExceptionCodeWithMessage(
        binder_exception_t exception, const char* message) __INTRODUCED_IN_API_Q__;
...
__attribute__((warn_unused_result)) AStatus* AStatus_fromServiceSpecificError(
        int32_t serviceSpecific) __INTRODUCED_IN_API_Q__;
...
__attribute__((warn_unused_result)) AStatus* AStatus_fromServiceSpecificErrorWithMessage(
        int32_t serviceSpecific, const char* message) __INTRODUCED_IN_API_Q__;
 ...
 */
bool AStatus_isOk(const AStatus* status) __INTRODUCED_IN_API_Q__;
 ...
 */
binder_exception_t AStatus_getExceptionCode(const AStatus* status) __INTRODUCED_IN_API_Q__;
 ...
 */
int32_t AStatus_getServiceSpecificError(const AStatus* status) __INTRODUCED_IN_API_Q__;
 ...
 */
binder_status_t AStatus_getStatus(const AStatus* status) __INTRODUCED_IN_API_Q__;
 ...
 */
const char* AStatus_getMessage(const AStatus* status) __INTRODUCED_IN_API_Q__;
 ...
 */
void AStatus_deleteDescription(const char* description) __INTRODUCED_IN_API_R__;
 ...
 */
void AStatus_delete(AStatus* status) __INTRODUCED_IN_API_Q__;
