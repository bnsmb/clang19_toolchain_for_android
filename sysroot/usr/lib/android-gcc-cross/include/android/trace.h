 ...
 * Available since API level 23.
 */
bool ATrace_isEnabled() __INTRODUCED_IN_API_M__;
 ...
 * Available since API level 23.
 */
void ATrace_beginSection(const char* sectionName) __INTRODUCED_IN_API_M__;
 ...
 * Available since API level 23.
 */
void ATrace_endSection() __INTRODUCED_IN_API_M__;
 ...
 */
void ATrace_beginAsyncSection(const char* sectionName, int32_t cookie) __INTRODUCED_IN_API_Q__;
 ...
 * \param cookie Unique identifier for distinguishing simultaneous events
 */
void ATrace_endAsyncSection(const char* sectionName, int32_t cookie) __INTRODUCED_IN_API_Q__;
 ...
 */
void ATrace_setCounter(const char* counterName, int64_t counterValue) __INTRODUCED_IN_API_Q__;
