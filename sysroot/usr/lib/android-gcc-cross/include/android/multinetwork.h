 ...
 */
int android_setsocknetwork(net_handle_t network, int fd) __INTRODUCED_IN_API_M__;
 ...
 * Available since API level 23.
 */
int android_setprocnetwork(net_handle_t network) __INTRODUCED_IN_API_M__;
 ...
 */
int android_getprocnetwork(net_handle_t *network) __INTRODUCED_IN_API_S__;
 ...
 * Available since API level 31.
 */
int android_setprocdns(net_handle_t network) __INTRODUCED_IN_API_S__;
 ...
 * Available since API level 31.
 */
int android_getprocdns(net_handle_t *network) __INTRODUCED_IN_API_S__;
...
int android_getaddrinfofornetwork(net_handle_t network,
        ...
        const struct addrinfo *hints, struct addrinfo **res) __INTRODUCED_IN_API_M__;
...
int android_res_nquery(net_handle_t network,
        const char *dname, int ns_class, int ns_type, uint32_t flags) __INTRODUCED_IN_API_Q__;
...
int android_res_nsend(net_handle_t network,
        const uint8_t *msg, size_t msglen, uint32_t flags) __INTRODUCED_IN_API_Q__;
...
int android_res_nresult(int fd,
        int *rcode, uint8_t *answer, size_t anslen) __INTRODUCED_IN_API_Q__;
 ...
 * Available since API level 29.
 */
void android_res_cancel(int nsend_fd) __INTRODUCED_IN_API_Q__;
 ...
 */
int android_tag_socket_with_uid(int sockfd, uint32_t tag, uid_t uid) __INTRODUCED_IN_API_T__;
 ...
 * Available since API level 33.
 */
int android_tag_socket(int sockfd, uint32_t tag) __INTRODUCED_IN_API_T__;
 ...
 * Available since API level 33.
 */
int android_untag_socket(int sockfd) __INTRODUCED_IN_API_T__;
