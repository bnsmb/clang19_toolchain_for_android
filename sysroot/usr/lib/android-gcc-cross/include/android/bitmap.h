 ...
 */
int32_t AndroidBitmap_getDataSpace(JNIEnv* env, jobject jbitmap)  __INTRODUCED_IN_API_R__;
...
int AndroidBitmap_compress(const AndroidBitmapInfo* info,
                           ...
                           void* userContext,
                           AndroidBitmap_CompressWriteFunc fn) __INTRODUCED_IN_API_R__;
...
int AndroidBitmap_getHardwareBuffer(JNIEnv* env, jobject bitmap,
        AHardwareBuffer** outBuffer) __INTRODUCED_IN_API_R__;
