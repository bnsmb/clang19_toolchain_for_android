...
uldn_close(ULocaleDisplayNames *ldn) __INTRODUCED_IN_API_S__;
...
uldn_getLocale(const ULocaleDisplayNames *ldn) __INTRODUCED_IN_API_S__;
...
uldn_getDialectHandling(const ULocaleDisplayNames *ldn) __INTRODUCED_IN_API_S__;
...
uldn_openForContext(const char * locale, UDisplayContext *contexts,
                    int32_t length, UErrorCode *pErrorCode) __INTRODUCED_IN_API_S__;
