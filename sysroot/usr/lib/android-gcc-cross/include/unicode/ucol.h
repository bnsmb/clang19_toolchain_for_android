...
ucol_open(const char *loc, UErrorCode *status) __INTRODUCED_IN_API_T__;
...
ucol_openRules( const UChar        *rules,
                ...
                UErrorCode         *status) __INTRODUCED_IN_API_T__;
...
ucol_close(UCollator *coll) __INTRODUCED_IN_API_T__;
...
ucol_strcoll(    const    UCollator    *coll,
        ...
        const    UChar        *target,
        int32_t            targetLength) __INTRODUCED_IN_API_T__;
...
ucol_getStrength(const UCollator *coll) __INTRODUCED_IN_API_T__;
...
ucol_setStrength(UCollator *coll,
                 UCollationStrength strength) __INTRODUCED_IN_API_T__;
...
ucol_getReorderCodes(const UCollator* coll,
                    ...
                    UErrorCode *pErrorCode) __INTRODUCED_IN_API_T__;
...
ucol_getAvailable(int32_t localeIndex) __INTRODUCED_IN_API_T__;
 ...
 */
U_CAPI int32_t U_EXPORT2 
ucol_countAvailable(void) __INTRODUCED_IN_API_T__;
...
ucol_openAvailableLocales(UErrorCode *status) __INTRODUCED_IN_API_T__;
 ...
 */
U_CAPI UEnumeration* U_EXPORT2
ucol_getKeywords(UErrorCode *status) __INTRODUCED_IN_API_T__;
 ...
 */
U_CAPI UEnumeration* U_EXPORT2
ucol_getKeywordValues(const char *keyword, UErrorCode *status) __INTRODUCED_IN_API_T__;
...
ucol_getFunctionalEquivalent(char* result, int32_t resultCapacity,
                             ...
                             UBool* isAvailable, UErrorCode* status) __INTRODUCED_IN_API_T__;
...
ucol_getSortKey(const    UCollator    *coll,
        ...
        int32_t        sourceLength,
        uint8_t        *result,
        int32_t        resultLength) __INTRODUCED_IN_API_T__;
...
ucol_mergeSortkeys(const uint8_t *src1, int32_t src1Length,
                   ...
                   uint8_t *dest, int32_t destCapacity) __INTRODUCED_IN_API_T__;
 ...
 */
U_CAPI void U_EXPORT2 
ucol_setAttribute(UCollator *coll, UColAttribute attr, UColAttributeValue value, UErrorCode *status) __INTRODUCED_IN_API_T__;
...
ucol_getAttribute(const UCollator *coll, UColAttribute attr, UErrorCode *status) __INTRODUCED_IN_API_T__;
 ...
 */
U_CAPI void U_EXPORT2
ucol_setMaxVariable(UCollator *coll, UColReorderCode group, UErrorCode *pErrorCode) __INTRODUCED_IN_API_T__;
...
ucol_getMaxVariable(const UCollator *coll) __INTRODUCED_IN_API_T__;
 ...
 */
U_CAPI UCollator* U_EXPORT2 ucol_clone(const UCollator *coll, UErrorCode *status) __INTRODUCED_IN_API_T__;
