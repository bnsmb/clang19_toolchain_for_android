...
uloc_getDefault(void) __INTRODUCED_IN_API_S__;
...
uloc_getLanguage(const char*    localeID,
         ...
         UErrorCode* err) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI const char* U_EXPORT2
uloc_getISO3Language(const char* localeID) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI const char* U_EXPORT2
uloc_getISO3Country(const char* localeID) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI const char* U_EXPORT2
uloc_getAvailable(int32_t n) __INTRODUCED_IN_API_S__;
 ...
 * \xrefitem stable "Stable" "Stable List" ICU 2.0
 */
U_CAPI int32_t U_EXPORT2 uloc_countAvailable(void) __INTRODUCED_IN_API_S__;
...
uloc_getISOLanguages(void) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI const char* const* U_EXPORT2
uloc_getISOCountries(void) __INTRODUCED_IN_API_S__;
...
uloc_isRightToLeft(const char *locale) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI const char* U_EXPORT2
uloc_toUnicodeLocaleKey(const char* keyword) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI const char* U_EXPORT2
uloc_toUnicodeLocaleType(const char* keyword, const char* value) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI const char* U_EXPORT2
uloc_toLegacyKey(const char* keyword) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI const char* U_EXPORT2
uloc_toLegacyType(const char* keyword, const char* value) __INTRODUCED_IN_API_S__;
