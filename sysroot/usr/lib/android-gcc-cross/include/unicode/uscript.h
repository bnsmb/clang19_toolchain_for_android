...
uscript_getCode(const char* nameOrAbbrOrLocale,UScriptCode* fillIn,int32_t capacity,UErrorCode *err) __INTRODUCED_IN_API_S__;
...
uscript_getName(UScriptCode scriptCode) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI const char*  U_EXPORT2
uscript_getShortName(UScriptCode scriptCode) __INTRODUCED_IN_API_S__;
...
uscript_getScript(UChar32 codepoint, UErrorCode *err) __INTRODUCED_IN_API_S__;
...
uscript_hasScript(UChar32 c, UScriptCode sc) __INTRODUCED_IN_API_S__;
...
uscript_getScriptExtensions(UChar32 c,
                            ...
                            UErrorCode *errorCode) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
uscript_getSampleString(UScriptCode script, UChar *dest, int32_t capacity, UErrorCode *pErrorCode) __INTRODUCED_IN_API_S__;
...
uscript_getUsage(UScriptCode script) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UBool U_EXPORT2
uscript_isRightToLeft(UScriptCode script) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UBool U_EXPORT2
uscript_breaksBetweenLetters(UScriptCode script) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UBool U_EXPORT2
uscript_isCased(UScriptCode script) __INTRODUCED_IN_API_S__;
