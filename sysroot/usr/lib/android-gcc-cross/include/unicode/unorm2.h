...
unorm2_getNFCInstance(UErrorCode *pErrorCode) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI const UNormalizer2 * U_EXPORT2
unorm2_getNFDInstance(UErrorCode *pErrorCode) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI const UNormalizer2 * U_EXPORT2
unorm2_getNFKCInstance(UErrorCode *pErrorCode) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI const UNormalizer2 * U_EXPORT2
unorm2_getNFKDInstance(UErrorCode *pErrorCode) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI const UNormalizer2 * U_EXPORT2
unorm2_getNFKCCasefoldInstance(UErrorCode *pErrorCode) __INTRODUCED_IN_API_S__;
...
unorm2_close(UNormalizer2 *norm2) __INTRODUCED_IN_API_S__;
...
unorm2_composePair(const UNormalizer2 *norm2, UChar32 a, UChar32 b) __INTRODUCED_IN_API_S__;
...
unorm2_getCombiningClass(const UNormalizer2 *norm2, UChar32 c) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UBool U_EXPORT2
unorm2_hasBoundaryBefore(const UNormalizer2 *norm2, UChar32 c) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UBool U_EXPORT2
unorm2_hasBoundaryAfter(const UNormalizer2 *norm2, UChar32 c) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UBool U_EXPORT2
unorm2_isInert(const UNormalizer2 *norm2, UChar32 c) __INTRODUCED_IN_API_S__;
