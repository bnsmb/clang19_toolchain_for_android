...
ubrk_close(UBreakIterator *bi) __INTRODUCED_IN_API_S__;
...
ubrk_current(const UBreakIterator *bi) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
ubrk_next(UBreakIterator *bi) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
ubrk_previous(UBreakIterator *bi) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
ubrk_first(UBreakIterator *bi) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
ubrk_last(UBreakIterator *bi) __INTRODUCED_IN_API_S__;
...
ubrk_preceding(UBreakIterator *bi,
           int32_t offset) __INTRODUCED_IN_API_S__;
...
ubrk_getAvailable(int32_t index) __INTRODUCED_IN_API_S__;
...
*/
U_CAPI int32_t U_EXPORT2
ubrk_countAvailable(void) __INTRODUCED_IN_API_S__;
...
ubrk_isBoundary(UBreakIterator *bi, int32_t offset) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI  int32_t U_EXPORT2
ubrk_getRuleStatus(UBreakIterator *bi) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI  int32_t U_EXPORT2
ubrk_getRuleStatusVec(UBreakIterator *bi, int32_t *fillInVec, int32_t capacity, UErrorCode *status) __INTRODUCED_IN_API_S__;
