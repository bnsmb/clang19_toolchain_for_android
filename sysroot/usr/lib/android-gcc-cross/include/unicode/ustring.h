...
u_strlen(const UChar *s) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
u_countChar32(const UChar *s, int32_t length) __INTRODUCED_IN_API_S__;
...
u_strHasMoreChar32Than(const UChar *s, int32_t length, int32_t number) __INTRODUCED_IN_API_S__;
...
u_strcat(UChar     *dst, 
    const UChar     *src) __INTRODUCED_IN_API_S__;
...
u_strncat(UChar     *dst, 
     const UChar     *src, 
     int32_t     n) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar * U_EXPORT2
u_strstr(const UChar *s, const UChar *substring) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar * U_EXPORT2
u_strFindFirst(const UChar *s, int32_t length, const UChar *substring, int32_t subLength) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar * U_EXPORT2
u_strchr(const UChar *s, UChar c) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar * U_EXPORT2
u_strchr32(const UChar *s, UChar32 c) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar * U_EXPORT2
u_strrstr(const UChar *s, const UChar *substring) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar * U_EXPORT2
u_strFindLast(const UChar *s, int32_t length, const UChar *substring, int32_t subLength) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar * U_EXPORT2
u_strrchr(const UChar *s, UChar c) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar * U_EXPORT2
u_strrchr32(const UChar *s, UChar32 c) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar * U_EXPORT2
u_strpbrk(const UChar *string, const UChar *matchSet) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
u_strcspn(const UChar *string, const UChar *matchSet) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
u_strspn(const UChar *string, const UChar *matchSet) __INTRODUCED_IN_API_S__;
...
u_strtok_r(UChar    *src, 
     const UChar    *delim,
           UChar   **saveState) __INTRODUCED_IN_API_S__;
...
u_strcmp(const UChar     *s1, 
         const UChar     *s2) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
u_strcmpCodePointOrder(const UChar *s1, const UChar *s2) __INTRODUCED_IN_API_S__;
...
u_strCompare(const UChar *s1, int32_t length1,
             ...
             UBool codePointOrder) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
u_strncmpCodePointOrder(const UChar *s1, const UChar *s2, int32_t n) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
u_strcasecmp(const UChar *s1, const UChar *s2, uint32_t options) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
u_strncasecmp(const UChar *s1, const UChar *s2, int32_t n, uint32_t options) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
u_memcasecmp(const UChar *s1, const UChar *s2, int32_t length, uint32_t options) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar* U_EXPORT2
u_memcpy(UChar *dest, const UChar *src, int32_t count) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar* U_EXPORT2
u_memmove(UChar *dest, const UChar *src, int32_t count) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar* U_EXPORT2
u_memset(UChar *dest, UChar c, int32_t count) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
u_memcmp(const UChar *buf1, const UChar *buf2, int32_t count) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI int32_t U_EXPORT2
u_memcmpCodePointOrder(const UChar *s1, const UChar *s2, int32_t count) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar* U_EXPORT2
u_memchr(const UChar *s, UChar c, int32_t count) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar* U_EXPORT2
u_memchr32(const UChar *s, UChar32 c, int32_t count) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar* U_EXPORT2
u_memrchr(const UChar *s, UChar c, int32_t count) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar* U_EXPORT2
u_memrchr32(const UChar *s, UChar32 c, int32_t count) __INTRODUCED_IN_API_S__;
