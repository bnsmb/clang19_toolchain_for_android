...
utext_close(UText *ut) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UText * U_EXPORT2
utext_openUTF8(UText *ut, const char *s, int64_t length, UErrorCode *status) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UText * U_EXPORT2
utext_openUChars(UText *ut, const UChar *s, int64_t length, UErrorCode *status) __INTRODUCED_IN_API_S__;
...
/**
  ...
  */
U_CAPI UText * U_EXPORT2
utext_clone(UText *dest, const UText *src, UBool deep, UBool readOnly, UErrorCode *status) __INTRODUCED_IN_API_S__;
...
utext_equals(const UText *a, const UText *b) __INTRODUCED_IN_API_S__;
...
utext_nativeLength(UText *ut) __INTRODUCED_IN_API_S__;
...
utext_char32At(UText *ut, int64_t nativeIndex) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar32 U_EXPORT2
utext_current32(UText *ut) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar32 U_EXPORT2
utext_next32(UText *ut) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UChar32 U_EXPORT2
utext_previous32(UText *ut) __INTRODUCED_IN_API_S__;
...
/**
  ...
  */
U_CAPI UChar32 U_EXPORT2
utext_next32From(UText *ut, int64_t nativeIndex) __INTRODUCED_IN_API_S__;
...
/**
  ...
  */
U_CAPI UChar32 U_EXPORT2
utext_previous32From(UText *ut, int64_t nativeIndex) __INTRODUCED_IN_API_S__;
...
/**
  ...
  */
U_CAPI int64_t U_EXPORT2
utext_getNativeIndex(const UText *ut) __INTRODUCED_IN_API_S__;
...
utext_setNativeIndex(UText *ut, int64_t nativeIndex) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI UBool U_EXPORT2
utext_moveIndex32(UText *ut, int32_t delta) __INTRODUCED_IN_API_S__;
...
utext_extract(UText *ut,
             ...
             UErrorCode *status) __INTRODUCED_IN_API_S__;
