...
u_versionToString(const UVersionInfo versionArray, char *versionString) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI void U_EXPORT2
u_getVersion(UVersionInfo versionArray) __INTRODUCED_IN_API_S__;
