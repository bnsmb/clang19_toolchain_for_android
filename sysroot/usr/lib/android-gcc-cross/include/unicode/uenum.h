...
uenum_close(UEnumeration* en) __INTRODUCED_IN_API_S__;
...
uenum_count(UEnumeration* en, UErrorCode* status) __INTRODUCED_IN_API_S__;
 ...
 */
U_CAPI void U_EXPORT2
uenum_reset(UEnumeration* en, UErrorCode* status) __INTRODUCED_IN_API_S__;
...
uenum_openUCharStringsEnumeration(const UChar* const strings[], int32_t count,
                                 UErrorCode* ec) __INTRODUCED_IN_API_S__;
