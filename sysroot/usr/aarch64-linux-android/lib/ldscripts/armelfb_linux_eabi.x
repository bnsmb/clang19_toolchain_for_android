...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("/data/local/tmp/sysroot/usr/aarch64-linux-android/lib"); SEARCH_DIR("/data/local/tmp/sysroot/usr/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
