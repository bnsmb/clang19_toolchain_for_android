...
OUTPUT_ARCH(aarch64)
ENTRY(_start)
SEARCH_DIR("/data/local/tmp/sysroot/usr/aarch64-unknown-linux-android/lib64"); SEARCH_DIR("/data/local/tmp/sysroot/usr/lib64"); SEARCH_DIR("/usr/local/lib64"); SEARCH_DIR("/lib64"); SEARCH_DIR("/usr/lib64"); SEARCH_DIR("/data/local/tmp/sysroot/usr/aarch64-unknown-linux-android/lib"); SEARCH_DIR("/data/local/tmp/sysroot/usr/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
