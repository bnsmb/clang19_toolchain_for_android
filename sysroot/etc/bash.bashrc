...
export host=android
export HOME=${HOME:=/data/local/tmp/sysroot/home/shell}
export HOSTNAME=$(getprop ro.product.device)
export TERM=${TERM:=xterm}
export TMPDIR=${TMPDIR:=/data/local/tmp/sysroot/tmp}
export USER=$(id -un)
export TERMINFO=${TERMINFO:=/data/local/tmp/sysroot/usr/share/terminfo}
